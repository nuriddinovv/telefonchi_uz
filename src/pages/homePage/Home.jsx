    ...
    <div className="container ">
      ...
      >
        <div className="flex gap-3 justify-center">
          ...
          <div className="flex flex-col gap-3 w-full">
            <div className="" data-aos="fade-left" data-aos-duration="4000">
              <Statistic title="Xodimlar soni" value={50} />
            </div>
            <div className="" data-aos="fade-left" data-aos-duration="5000">
      ...
      <div className="my-6 rounded-lg shadow-xl p-8 lg:p-16">
        ...
        <div className="flex flex-wrap justify-between lg:gap-4 ">
          <div
            data-aos="zoom-out-down"
            className="w-[48%] md:w-[24%] hover:shadow-md transition-all  hover:scale-110 shadow h-[100px] flex p-8 items-center justify-center"
          >
            <img
              className="w-full"
